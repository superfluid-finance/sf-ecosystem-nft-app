...
export const ClaimStreamModal = ({ setModalOpen }: ClaimStreamModalProps) => {
  ...
  const NFTPreview = () => {
    return (
      <img src={NFTPreviewImage} className="mx-auto max-h-[20rem]"  style={{ background: `url(/modal-sf-bg.png)`}} />
    )
  }
    ...
    <div className="w-screen h-screen fixed top-0 left-0 z-[100] flex items-center justify-center">
     ...
     <div className="p-12 bg-white relative max-w-[36rem] rounded-[1.25rem]">
      ...
      <div className="flex flex-col">
        <h4 className="text-md font-bold text-[#2E3A47] text-center">Success</h4>
        ...
        <div className="flex flex-col gap-y-8 mt-6 !bg-no-repeat !bg-[center_-3rem]" style={{ background: `url(/modal-sf-bg.png)`}}>
        <NFTPreview />
        <ClaimStreamButton />
        </div>
      </div>
